<%-- 
    Document   : cancel
    Created on : Jan 27, 2022, 9:52:10 AM
    Author     : bhasi
--%>
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">BREEZE</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html"></a></span></p>
					...
					<div class="booking-form">
						<form action="cancelBooking" method="post">
							<div class="row no-margin">
								...
								<div class="col-md-3">
									<div class="form-btn">
										<button type="submit" class="submit-btn">Cancel Booking</button>
									</div>
								</div>
							</div>
						</form>
