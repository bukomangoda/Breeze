          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pr-3 text-md-right">
	        			<div class="d-md-flex text align-items-center">
	        				<h3 class="order-md-last heading-left"><span>Banana & Vanilla Cake </span></h3>
	        				<span class="price price-left">LKR 330.00</span>
	        			</div>
	        			<div class="d-block">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pr-3 text-md-right">
	        			<div class="d-md-flex text align-items-center">
	        				<h3 class="order-md-last heading-left"><span>Cake with chocolate </span></h3>
	        				<span class="price price-left">LKR 679.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pr-3 text-md-right">
	        			<div class="d-md-flex text align-items-center">
	        				<h3 class="order-md-last heading-left"><span>Sweet Strawberry Cake</span></h3>
	        				<span class="price price-left">LKR 320.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pr-3 text-md-right">
	        			<div class="d-md-flex text align-items-center">
	        				...
	        				<span class="price price-left">LKR 1690.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-md-flex text align-items-center">
	        				...
	        				<span class="price">LKR 1700.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-md-flex text align-items-center">
	        				<h3><span>spaghetti made with mushrooms</span></h3>
	        				<span class="price">LKR 690.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-md-flex text align-items-center">
	        				<h3><span>Fresh Mango Shake</span></h3>
	        				<span class="price">LKR 890.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-md-flex text align-items-center">
	        				<h3><span>Mango Lassi </span></h3>
	        				<span class="price">LKR 620.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
